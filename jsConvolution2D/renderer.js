...
async function loadImage() {
    try {
        const imageData = await ipcRenderer.invoke('select-image');
        ...
        calcText.textContent = 'Error loading image: ' + error.message;
    }
}

// Event listeners
selectImageBtn.addEventListener('click', loadImage);
